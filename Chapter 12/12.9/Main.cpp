...
int main()
{
	...
	cout << "Package 1:\n\nSender:\n" << package1.getSenderName()
		...
		<< " " << package1.getSenderZipCode();
	cout << "\n\nRecipient:\n" << package1.getReceiverName()
		<< "\n" << package1.getReceiverAddress()
		<< "\n" << package1.getReceiverCity() << ", " << package1.getSenderState()
		<< " " << package1.getSenderZipCode();
	...
	cout << "Package 2:\n\nSender:\n" << package2.getSenderName()
		...
		<< " " << package2.getSenderZipCode();
	cout << "\n\nRecipient:\n" << package2.getReceiverName()
		<< "\n" << package2.getReceiverAddress()
		<< "\n" << package2.getReceiverCity() << ", " << package2.getSenderState()
		<< " " << package2.getSenderZipCode();
	...
	cout << "Package 3:\n\nSender:\n" << package3.getSenderName()
		...
		<< " " << package3.getSenderZipCode();
	cout << "\n\nRecipient:\n" << package3.getReceiverName()
		<< "\n" << package3.getReceiverAddress()
		<< "\n" << package3.getReceiverCity() << ", " << package3.getSenderState()
		<< " " << package3.getSenderZipCode();
